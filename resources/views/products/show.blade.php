            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('products.index') }}" class="ml-1 text-gray-400 hover:text-white transition-colors md:ml-2">Productos</a>
                    </div>
                </li>
        ...
        <div class="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl border border-gray-700/50 shadow-xl overflow-hidden mb-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 p-6">
                ...
                <div class="flex flex-col">
                    <div class="mb-6">
                        <div class="text-sm text-gray-400 mb-1">Código del Producto</div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div>
                            <div class="text-sm text-gray-400 mb-1">Precio con Descuento</div>
                        ...
                        <div>
                            <div class="text-sm text-gray-400 mb-1">Cantidad</div>
                            <div class="text-lg font-medium text-gray-200">{{ $product->qty }} unidades</div>
                        </div>

                        <div>
                            <div class="text-sm text-gray-400 mb-1">Categoría</div>
                            <div class="text-lg font-medium text-gray-200">{{ $product->category ? $product->category->cat_name : 'Sin Categoría' }}</div>
                        </div>
                    </div>

                    @if($product->description)
                        <div class="mb-6">
                            <div class="text-sm text-gray-400 mb-2">Descripción</div>
