            ...
            <div class="bg-white shadow-md rounded-lg overflow-hidden">
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">ID de Pedido</th>
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex gap-2">
                                        ...
                                        <form action="{{ route('cart.destroy', $purchase->id) }}" method="POST" onsubmit="return confirm('¿Está seguro de que desea eliminar este pedido?');">
                                            @csrf
                                            @method('DELETE')
